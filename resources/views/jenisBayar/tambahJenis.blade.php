...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form method="POST" action="/jenisBayar/store" class="form-horizontal" enctype="multipart/form-data">
                    	@csrf
                        <div class="card-header card-header-text" data-background-color="rose">
                            <h4 class="card-title">Form Tambah Jenis Pembayaran</h4>
                        </div>
                        <div class="card-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <select class="selectpicker" name="jenis_pembayaran" data-style="btn " title="Pilih Jenis Pembayaran" >
                                        @foreach($jenis as $t)
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group label-floating is-empty">
                                        ...
                                        <input type="text" name="nominal" onkeyup="this.value=addcommas(this.value);" class="form-control" required="true" value="{{old('nominal')}}">      
                                    </div>
                                </div>
                            </div>
                            <div class="row">
