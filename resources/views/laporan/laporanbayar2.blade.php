...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form method="get" action="{{url('/laporanbayar/carikelas')}}" class="form-horizontal">
            ...
            <div class="row">
                ...
                <div class="col-md-5"></div>
                <div class="col-md-2"><a href="/laporanbayar/cetak_pdf/{{$lapBayar[0]->kelas}}" class="btn btn-rose">Cetak</a></div>
            </div>
        </div>
        </div>
    </div>
