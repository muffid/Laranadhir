...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form method="POST" action="/guruStore" class="form-horizontal" enctype="multipart/form-data">
                    	@csrf
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group label-floating is-empty">
                                        <label class="control-label"></label>
                                        <input type="text" name="nuptk" class="form-control" required="true" value="{{old('nuptk')}}">           
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group label-floating is-empty">
                                        <label class="control-label"></label>
                                        <input type="text" name="ket" class="form-control" value="{{old('ket')}}">           </div>
                                </div>
                            </div>
                        </br>
                            <div class="row">
	                        	...
	                        	<div class="col-md-3 col-sm-4">
	                                ...
	                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
	                                    <div class="fileinput-new thumbnail img-circle">
	                                        <img src="{{asset('material/assets/img/placeholder.jpg')}}" alt="...">
	                                    </div>
