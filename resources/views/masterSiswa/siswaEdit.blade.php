...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form method="POST" action="/siswaUpdate/{{$siswa->id}}" class="form-horizontal" enctype="multipart/form-data">
                    	@csrf
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group label-floating is-empty">
                                        <label class="control-label"></label>
                                        <input type="text" name="noInduk" class="form-control" value="{{$siswa->noInduk}}">           
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <select class="selectpicker" name="tapel" data-style="btn btn-primary " data-size="6">
                                        <option value="{{$siswa->tapel}}">{{$siswa->tapel}}</option>
