                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 checkbox-radios">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="pendaftaran" value="{{$nominal0}}">@currency($nominal0)
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-9 checkbox-radios">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="seragam" value="{{$nominal1}}">@currency($nominal1)
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-9 checkbox-radios">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="atk" value="{{$nominal2}}">@currency($nominal2)
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-9 checkbox-radios">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="ekskul" value="{{$nominal3}}">@currency($nominal3)
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-9 checkbox-radios">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="lks1" value="{{$nominal4}}">@currency($nominal4)
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-9 checkbox-radios">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="lks2" value="{{$nominal5}}">@currency($nominal5)
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text left">
                                            <b>@currency($totalterbayar)</b>
                                        </td>
                                        <td class="text left">
                                            <b>@currency($totaltunggakan)</b>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
